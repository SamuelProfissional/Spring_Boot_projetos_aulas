...
public class ProjetoescolaApplication /* ~~(Could not parse as Java)~~> *//* ~~(Could not parse as Java)~~> */ {
	...
	// @Autowired pega o objeto e instancia ele automaticamente, ex: (da new Objeto)
	// automaticamente
	public CommandLineRunner init(@Autowired CursoRepository cursoRepository,
			...
			@Autowired DiciplinaRepository diciplinaRepository, @Autowired ProfessorRepository professorRepository) {
	...
	public static void main(String[] args) {
		...
		Usuario usuario = new Usuario(0, "Samuel", "samuel.RODRIGUES@facens.br", passwordEncoder.encode("123"), "Administrador");
